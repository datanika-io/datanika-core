...
def upgrade() -> None:
    ...
    op.execute("UPDATE dependencies SET upstream_type = 'upload' WHERE upstream_type = 'pipeline'")
    op.execute(
        "UPDATE dependencies SET downstream_type = 'upload' WHERE downstream_type = 'pipeline'"
    )
    op.execute("UPDATE catalog_entries SET origin_type = 'upload' WHERE origin_type = 'pipeline'")
...
def downgrade() -> None:
    ...
    op.execute("UPDATE dependencies SET upstream_type = 'pipeline' WHERE upstream_type = 'upload'")
    op.execute(
        "UPDATE dependencies SET downstream_type = 'pipeline' WHERE downstream_type = 'upload'"
    )
    op.execute("UPDATE catalog_entries SET origin_type = 'PIPELINE' WHERE origin_type = 'upload'")
