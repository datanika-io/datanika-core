...
def _org_block() -> rx.Component:
    ...
    return _fact(
        ...
        rx.vstack(
            ...
            rx.text(_t["mcp_consent.org_hint"], size="1", color="var(--gray-11)"),
            spacing="1",
            width="100%",
        ),
    )
...
def _read_only_access() -> rx.Component:
    ...
    return rx.vstack(
        ...
        rx.hstack(
            ...
            rx.text(_t["mcp_consent.cannot_write"], size="2", color="var(--gray-11)"),
            spacing="2",
            align="start",
        ),
        spacing="2",
...
def _prompt() -> rx.Component:
    return rx.vstack(
        ...
        rx.vstack(
            ...
            rx.text(_t["mcp_consent.wants_access"], size="2", color="var(--gray-11)"),
            spacing="1",
            align="start",
            width="100%",
        ),
