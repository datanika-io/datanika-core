...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                "bigquery", "snowflake", "redshift", "s3", "csv", "json", "parquet",
                name="connectiontype", native_enum=False, length=30,
            ),
            nullable=False,
        ),
        sa.Column(
            ...
            sa.Enum(
                ...
                name="connectiondirection", native_enum=False, length=20,
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                name="pipelinestatus", native_enum=False, length=20,
            ),
            nullable=False,
        ),
        sa.Column("org_id", sa.BigInteger(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                name="materialization", native_enum=False, length=20,
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                name="nodetype", native_enum=False, length=20,
            ),
            nullable=False,
        ),
        ...
        sa.Column(
            ...
            sa.Enum(
                "pipeline", "transformation",
                name="nodetype_1", native_enum=False, length=20,
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                "pipeline", "transformation",
                name="nodetype_run", native_enum=False, length=20,
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                "pipeline", "transformation",
                name="nodetype_sched", native_enum=False, length=20,
            ),
            nullable=False,
        ),
        sa.Column("target_id", sa.BigInteger(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "action",
            sa.Enum(
                "create", "update", "delete", "login", "logout", "run",
                name="auditaction", native_enum=False, length=20,
            ),
            nullable=False,
        ),
