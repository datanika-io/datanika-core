...
These three moved here on 2026-08-31 from a local planning directory outside any git repository.
They previously cross-referenced two documents that did **not** move and are not public:
